...
export function HowItWorks(): JSX.Element {
  return (
    <section id="how-it-works" className="py-[var(--space-2xl)] bg-[var(--color-surface-sunken)] scroll-mt-16">
      <div className="w-full max-w-[1400px] mx-auto px-[var(--space-lg)]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[var(--space-md)] mb-[var(--space-xl)]">
          {steps.map((step) => (
            <div
              key={step.number}
              className="p-[var(--space-md)] bg-[var(--color-surface-raised)] border-2 border-[var(--color-border)] rounded-[var(--radius-lg)]"
            >
        ...
        <div className="max-w-4xl mx-auto p-[var(--space-lg)] bg-[var(--color-surface-raised)] border-2 border-[var(--color-border)] rounded-[var(--radius-lg)]">
          <p className="text-center text-sm text-[var(--color-ink-subtle)] mb-[var(--space-md)]">
