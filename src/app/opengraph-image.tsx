    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '40px' }}>
          ...
          <span style={{ fontSize: '28px', color: '#1B3D2F', fontWeight: 600 }}>Quorum Tours</span>
        </div>

        {/* Headline */}
        <div style={{
          fontSize: '72px', fontWeight: 700, color: '#1B3D2F',
          ...
          {[
            ...
            <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column' }}>
                <span style={{ fontSize: '20px', fontWeight: 600, color: '#1B3D2F' }}>{step.label}</span>
                <span style={{ fontSize: '16px', color: '#607d70' }}>{step.desc}</span>
              </div>
            </div>
          ))}
        </div>
